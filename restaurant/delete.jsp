...
<% 
	...
	String attach_filename   = (String)sqlMap.queryForObject("restaurantFilename", fmap);
	...
	if (attach_filename != null){
		...
		out.println(savedir  + "thumb_" + attach_filename);
		thumbfile.delete();
	...
	sqlMap.delete("restaurantDelete", map);
	
	StringUtility strobj = new StringUtility();
	String  goURL = strobj.generateForRestaurantURL(Integer.parseInt(globalMenu), Integer.parseInt(localMenu), dbName, "viewlist", Integer.parseInt(pageNumber), divisionCode, accessCode, categoryCode);
