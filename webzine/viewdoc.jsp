...
<%
	...
	dataobj = (BoardDataObject)sqlMap.queryForObject("webzineArticle", artclemap);
...
<%
	...
	pnndataobj = (PrevAndNextDataObject)sqlMap.queryForObject("webzinePrevAndNextArticle", pnnmap);
