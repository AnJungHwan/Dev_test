...
<table class="normal">	
<form method="post" name="formName" action="/baas/blog/edit.jsp">
...
<tr>
	...
	<%
		...
		categoryList = sqlMap.queryForList("clubCategoryList", dbName);
...
<tr>
	<td style="width:100px; color:#000; font-weight:bold; text-align:right">* 요약 : </td>
	<td style="width:850px; text-align:left">
	<input style="width: 700px" type="text" class="thin" name="summary" maxlength="250" value="<%=dataobj.getSummary()%>">
	</td>
</tr>	
<tr>
...
<tr>
	<td style="color:#000; font-weight:bold; text-align:right" >* 이미지 : </td>
	<td style="text-align:left">
	<script language="javascript">
			makeSwfSingleUpload(
