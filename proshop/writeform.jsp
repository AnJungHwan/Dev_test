...
<table class="normal">	
<form method="post" name="formName" action="/baas/proshop/write.jsp">
...
<tr><td colspan="2">
	...
	<span class="btn white large"><input type="button" value="제품  등록" class="btn" onClick="$.submitForm();"></span>
	</td>
</tr>
</table>
</form>
