...
<%
	...
	String  fileName  = divisionFolder + "_banner.xml";
	...
	xmlList = sqlMap.queryForList("subBannerXmlList", division_code);
	String goURL = null;
	String goLink = null;
	for(int i=0; i < xmlList.size(); i++){
		SubBannerDataObject dataobj = (SubBannerDataObject) xmlList.get(i);
		...
		//Text값을 설정한다.
		goURL = "/upload/sub_banner/" + divisionFolder + "/" + dataobj.getFilename();
