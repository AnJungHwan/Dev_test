...
<table class="normal">	
<form method="post" name="formName" action="/baas/sub_banner/write.jsp">
...
<tr>
	...
	<br><br>배너  사이즈는  270 X 160 입니다.<br>
	</td>
</tr>
<tr>
...
<tr><td colspan="2">
	...
	<span class="btn white large"><input type="button" value="배너  등록" class="btn" onClick="$.submitForm();"></span>
	</td>
</tr>
