	...
	$.extend({
		confirmDelete : function(global, local, db, page, doc, div) {
			if(!confirm("정말로 삭제하겠습니까?")){
				...
				document.location = "/baas/sub_flash/delete.jsp?global_menu=" + global + "&local_menu=" + local + "&db=" + db + "&page=" + page + "&doc=" +doc + "&div=" +div;
			}
		}
	});
});
//-->
 ...
 <%
 	if (!sessionSuperuserAccessLevel.equals("SUPER")){
   	...
   	dataobj = (SubFlashDataObject)sqlMap.queryForObject("subFlashArticle",  Integer.toString(docNumber));
...
<table class="normal">	
<form method="post" name="formName" action="/baas/sub_flash/edit.jsp">
