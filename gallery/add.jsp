...
<%
	...
	String  division_code = request.getParameter("division_code");
	String  gallery_code = request.getParameter("gallery_code");
	...
	//out.println("<script>alert('" + savedir + "');</script>");  
	
	String originalFile  = null;
	String  thumbFile  = null;
	
	int  filecount  = Integer.parseInt(totalCount);
	...
	if(alist != null){
		...
		for(int i=0;objarr!=null&&i<objarr.length;i++){
            ...
            //thumb.convert(originalFile,originalFile, 640);  //2019.12.06
...
//			out.println(filecount);
	...
	sqlMap.update("galleryCountUpdate", map);
