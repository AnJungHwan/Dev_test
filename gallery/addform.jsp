...
//-->
 ...
 <%
	...
	//out.println("<script>alert('" + divisionName + "');</script>"); 
...
<table class="normal">	
<form method="post" name="formName" action="/baas/gallery/add.jsp">
<tr><td class="line" colspan=2><hr></td></tr>
<tr>
	<td style="width:100px; color:#000; font-weight:bold; text-align:right">* 제목 : </td>
	<td style="width:850px; text-align:left"><%=dataobj.getTitle()%><br>
	</td>
</tr>	
<tr>
	<td style="color:#000; font-weight:bold; text-align:right">* 사업장 : </td>
	<td style="text-align:left"><%=dataobj.getDivision_name() %><br>
...
<tr><td colspan="2">
	...
	<input type="hidden" name="title" value="<%=dataobj.getTitle()%>"><br>
	<input type="hidden" name="gallery_code" value="<%=dataobj.getGallery_code()%>"><br>
	<input type="hidden" name="totalcount" value="<%=dataobj.getTotalcount()%>"><br>
	<input type="hidden" name="division_name" value="<%=dataobj.getDivision_name()%>"><br>
	<input type="hidden" name="division_code" value="<%=dataobj.getDivision_code()%>"><br>
	...
	<span class="btn white large"><input type="button" value="사진 추가"  onClick="$.submitForm();"></span>
	</td>
</tr>
</table>
</form>
